...
dist1 = c(rep(kats[1], 20), rep(kats[2],40), rep(kats[3],30), 
           rep(kats[4],50), rep(kats[5], 5))
...
Gegeben seien die **nominalen** Variablen A, B, C, D, E und F mit den Ausprägungen `r paste(kats[1], ", ", kats[2], ", ", kats[3], ", ", kats[4], " und ", kats[5], sep = "")`. `r return(ifelse(displ == "Tabelle", "Der folgenden Tabelle", "Den folgenden Grafiken"))` können Sie entnehmen, welche Kategorie in welcher Variable wie oft vorkommt.
...
Welche beiden Variablen haben jeweils eine sehr ähnliche Streuung?


Answerlist
----------
* A und B; C und F; D und E
* B und C; A und D; F und E 
* F und A; C und F; B und E 
* A und B; D und C; E und F 
* F und E; C und D; B und A 
